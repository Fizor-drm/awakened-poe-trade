const exact: Record<string, string> = {
  ...
  'Quit': '終了',
  'Support development on': '開発を支援',
  'Blighted': 'ブライト化',
  'Blight-ravaged': '荒廃したブライト',
  'Magic': 'マジック',
  'Superior': '上質',
  'Anomalous': '異常',
  'Divergent': '分岐',
  ...
  'Staff': 'スタッフ',
  'Sceptre': 'セプター',
  'No relevant stats were found': '関連するステータスが見つかりません',
  'Hidden': '非表示',
  'Collapse': '折りたたむ',
  'Mods': 'モッド',
  'Pseudo': '疑似',
  ...
  'Stopwatch': 'ストップウォッチ',
  'paused': '停止中',
  'Start and Pause': '開始／一時停止',
  'Reset': 'リセット',
  'Keys': 'キー',
  'Stash search': 'スタッシュ検索',
  'search text or regex': '検索テキストまたは正規表現',
  'friendly name': '表示名',
  'Image strip': '画像ストリップ',
  'Item search': 'アイテム検索',
  'Search by name…': '名前で検索…',
  'Reset items': 'アイテムをリセット',
  'Skill Gem': 'スキルジェム',
  'Replicas': 'レプリカ',
  'No items found.': 'アイテムが見つかりません。',
  'Map check': 'マップ確認',
  'Profile': 'プロファイル',
  'Only selected': '選択項目のみ',
  'Trade site request failed': '取引サイトへのリクエストに失敗しました',
  'Trade': '取引',
  'Price': '価格',
  'Stock': '在庫',
  'Seller': '販売者',
  ...
  'Language': '言語',
  'Account name': 'アカウント名',
  'Last character name': '最後のキャラクター名',
  'Add command': 'コマンドを追加',
  'Not Set': '未設定',
  'Overlay': 'オーバーレイ',
  'Hotkeys': 'ホットキー',
  ...
  'About': '情報',
  'Font size': 'フォントサイズ',
  'PoE log file': 'PoEログファイル',
  'PoE config file': 'PoE設定ファイル',
  'Restore clipboard': 'クリップボードを復元',
  'Price check': '価格チェック',
  'Auto-hide Mode': '自動非表示モード',
  'Open without auto-hide': '自動非表示なしで開く',
  'Show seller': '販売者を表示',
  'Fill stat values': 'ステータス値を入力',
  'Exact value': '正確な値',
  'Show price prediction': '価格予測を表示'
}
...
Object.assign(exact, {
  ...
  'Level': 'レベル',
  'Quality': '品質',
  'from poe.ninja …': 'poe.ninja から…',
  'Background when the Overlay is clickable': 'オーバーレイをクリック可能にしたときの背景',
  'Transparent': '透明',
  'Clicking on the background focuses the game': '背景をクリックするとゲームにフォーカスする',
  ...
  'Offline': 'オフライン',
  'Error': 'エラー',
  'Not recognized modifier': '認識できないモッド',
  'No': 'いいえ',
  'Yes': 'はい',
  'You': 'あなた',
  '1 Empty or Crafted Modifier': '空きまたはクラフト済みモッドが1個',
  'Any': '任意',
  'Prefix': '接頭辞',
  'Suffix': '接尾辞',
  'Find in Stash': 'スタッシュ内を検索',
  'An error occurred while parsing the item': 'アイテム解析中にエラーが発生しました',
  'This is probably a bug and you can report it on GitHub.': 'これは不具合の可能性があります。GitHubで報告してください。',
  'Unknown Item': '不明なアイテム',
  'Open item on wiki': 'Wikiでアイテムを開く',
  'Open item on PoEDB': 'PoEDBでアイテムを開く',
  'Open base item on Craft of Exile': 'Craft of Exileでベースアイテムを開く',
  'Item info': 'アイテム情報',
  'Corrupted': '破損',
  'Unidentified': '未鑑定',
  'Veiled': '覆い隠し',
  ...
  'Rune Dagger': 'ルーンダガー',
  'Warstaff': 'ウォースタッフ',
  'Cluster Jewel': 'クラスタージュエル',
  'Heist Blueprint': 'ハイスト設計図',
  'Heist Contract': 'ハイスト契約書',
  'Heist Tool': 'ハイストツール',
  'Heist Brooch': 'ハイストブローチ',
  'Heist Gear': 'ハイスト装備',
  'Heist Cloak': 'ハイストクローク',
  'Trinket': 'トリンケット',
  'Sanctum Relic': 'サンクタムレリック',
  'Tincture': 'ティンクチャー',
  'Charm': 'チャーム',
  'Idol': 'アイドル',
  'Graft': 'グラフト',
  'Stats ignored': 'ステータスを無視',
  'Roll is not variable': 'ロール値は固定',
  'Elemental damage is not the main source of DPS': '元素ダメージは主なDPS源ではありません',
  'Physical damage is not the main source of DPS': '物理ダメージは主なDPS源ではありません',
  'Filtering by exact Elemental Resistance unreasonably increases the price': '元素耐性を厳密指定すると価格が不当に上がります',
  'Buyer will likely change anointment': '購入者はアノイントを変更する可能性があります',
  'Any Currency': 'すべての通貨',
  'Chaos Orb': 'カオスオーブ',
  'Divine Orb': '神聖のオーブ',
  'You may have an outdated version': '古いバージョンを使用している可能性があります',
  'You have the latest version': '最新バージョンです',
  'Error while checking for updates': 'アップデート確認中にエラーが発生しました',
  'Checking for updates': 'アップデートを確認中',
  'Downloading…': 'ダウンロード中…',
  'Open the Downloads page': 'ダウンロードページを開く',
  'You have disabled automatic updates download': '自動アップデートのダウンロードは無効です',
  'Heist target:': 'ハイストターゲット:',
  'Replicas': 'レプリカ',
  'Map check': 'マップ確認',
  'Only selected': '選択項目のみ',
  'bulk': 'まとめ買い',
  ...
  'iLvl': 'アイテムLv',
  'Market Ratio': '市場比率',
  'or Private League': 'またはプライベートリーグ',
  'Last character name': '最後のキャラクター名',
  'press Enter': 'Enterを押す',
  'You can clear hotkey by pressing Backspace': 'Backspaceでホットキーを解除できます',
  'Stash tab scrolling': 'スタッシュタブのスクロール',
  'Grid for Delve Chart': 'デルヴチャートのグリッド',
  'PoE window title': 'PoEウィンドウタイトル',
  'App development continues thanks to:': 'アプリ開発への協力:',
  'Record all key presses': 'すべてのキー入力を記録',
  'Force the English version of the site': '公式サイトの英語版を強制する',
  'Enable builtin browser': '内蔵ブラウザを有効化',
  'Your items will be highlighted even if this setting is off': 'この設定をオフにしてもアイテムはハイライトされます',
  'Show memorized cursor position': '記憶したカーソル位置を表示',
  'Extra time to prevent spurious Rate limiting': '不要なレート制限を防ぐための追加待機時間',
  'Show indication on collapsed listings': '折りたたまれた出品にも表示する',
  'Perform an auto search, when pressing': 'キーを押したときに自動検索する'
})
